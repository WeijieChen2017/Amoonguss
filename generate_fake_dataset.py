...
CT_list = sorted(glob.glob("./data_dir/t1_ct_norm/*.nii.gz"))
MR_list = sorted(glob.glob("./data_dir/t1_mr_norm/*.nii.gz"))

fake_dataset_folder = "./data_dir/Task11_SynthRad_task1_npy/"
