...
# the ct file is in ./data_dir/Task_1/brain/1BA001/ct.nii.gz
...
for sct_path in sct_file_list:
    ...
    sct_dst = "./data_dir/Task_1/"+organ+"/"+case_id+"/sct_v3a_last.nii.gz"
    std_dst = "./data_dir/Task_1/"+organ+"/"+case_id+"/std_v3a_last.nii.gz"
